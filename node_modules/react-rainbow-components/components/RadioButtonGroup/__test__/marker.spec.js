...
describe('<Marker />', function () {
  it('should not render when it is not visible', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_marker["default"], null));
  ...
  it('should set the right position and size', function () {
    ...
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_marker["default"], {
      isVisible: true,
      style: style
    }));
