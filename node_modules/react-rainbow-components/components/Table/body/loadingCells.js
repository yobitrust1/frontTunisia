...
function LoadingCells(_ref) {
  ...
  if (value > 0) {
    return Array(columns.length).fill().map(function (item, index) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_tdLoadingContainer["default"], {
        key: key
      }, /*#__PURE__*/_react["default"].createElement(_loadingCell["default"], {
        "data-id": "table_body--loading"
      }, /*#__PURE__*/_react["default"].createElement(_RenderIf["default"], {
        isTrue: index < value
      }, /*#__PURE__*/_react["default"].createElement(_elementLoading["default"], {
        style: styles
      }))));
    });
  }
