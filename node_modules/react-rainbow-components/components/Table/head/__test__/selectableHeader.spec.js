...
describe('SelectableHeader', function () {
  it('should not render the PrimitiveCheckbox when maxRowSelection is 1', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_selectableHeader["default"], {
      maxRowSelection: 1
    }));
  ...
  it('should set scope to "col" in th element', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_selectableHeader["default"], null));
