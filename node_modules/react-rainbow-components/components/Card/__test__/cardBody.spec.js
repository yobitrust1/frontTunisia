...
describe('<CardBody/>', function () {
  it('should render the Spinner when isLoading is passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_cardBody["default"], {
      isLoading: true
    }, "Test"));
  ...
  it('should not render the Spinner when isLoading is not passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_cardBody["default"], null, "Test"));
  ...
  it('should render the children when isLoading is not passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_cardBody["default"], null, /*#__PURE__*/_react["default"].createElement("div", null, "Test")));
