...
describe('<Content/>', function () {
  it('should return the label when there are not children', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_content["default"], {
  ...
  it('should return children when label is not passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_content["default"], null, "Children in Content"));
    expect(component.find('span').text()).toBe('Children in Content');
  });
});