...
describe('<StepThree />', function () {
  it('should have the assign field modal closed by default', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], baseParams));
  ...
  it('should call getAssignFieldsData with the right data', function () {
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], (0, _extends2["default"])({}, baseParams, {
      matchField: ""
    })));
