...
describe('<PreviewTable />', function () {
  it('should render a spinner when isLoading is passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_previewTable["default"], {
      data: data,
      columns: columns,
      isLoading: true
    }));
  ...
  it('should render a table when preview isLoading is not passed', function () {
    var component = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_previewTable["default"], {
      data: data,
      columns: columns,
      isLoading: false
    }));
    expect(component.find(_table["default"]).exists()).toBe(true);
  });
