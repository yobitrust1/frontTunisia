...
describe('<UploadFileButton />', function () {
  it('should call uniqueId with the right value', function () {
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_uploadFileButton["default"], {
  ...
  it('should associate the input and label with the same id', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_uploadFileButton["default"], {
      onChange: function onChange() {}
    }));
