...
describe('<Preview />', function () {
  it('should show default labels', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_preview["default"], null));
  ...
  it('should set the right labels according to params', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_preview["default"], {
  ...
  it('should have data passed properly to preview table', function () {
    ...
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_preview["default"], props));
