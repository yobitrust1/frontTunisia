...
describe('<StepFour />', function () {
  it('should call getPreviewDataToImport with the right values', function () {
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], props));
    var data = [{
      Name: 'John',
      Email: 'john@gmail.com'
    }, {
  ...
  it('should render the right amount of columns', function () {
    var component = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_["default"], props));
