 ...
 * @class
 */
var PageVerticalSectionOverflow = /*#__PURE__*/function () {
  /**
  ...
  (0, _createClass2["default"])(PageVerticalSectionOverflow, [{
    ...
    value: function click() {
      $(this.rootElement).$('[data-id="vertical-overflow-button"]').click();
    }
    /**
    ...
    value: function hasFocusButton() {
      return $(this.rootElement).$('[data-id="vertical-overflow-button"]').isFocused();
    }
  }]);
