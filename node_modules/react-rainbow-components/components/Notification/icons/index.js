...
var iconMap = {
  ...
  success: function success() {
    return /*#__PURE__*/_react["default"].createElement(_successIcon["default"], null);
  }
};
...
function VariantIcon(_ref) {
  ...
  if (iconMap[icon]) {
    return /*#__PURE__*/_react["default"].createElement(_iconContainer["default"], {
      icon: icon
    }, iconMap[icon]());
  }
...
function Icon(_ref2) {
  ...
  if (typeof icon === 'string') {
    return /*#__PURE__*/_react["default"].createElement(VariantIcon, {
      icon: icon
    });
  }

  return /*#__PURE__*/_react["default"].createElement(_iconContainer["default"], null, icon);
}
