...
describe('<ReCaptchaWrapper />', function () {
  it('should not render when isScriptLoaded and isScriptLoadSucceed are false', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_wrapper["default"], null));
    component.setProps({
  ...
  it('should render the ReCaptcha loader with the right props', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_wrapper["default"], {
