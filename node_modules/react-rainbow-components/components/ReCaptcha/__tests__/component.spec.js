...
describe('<ReCaptchaComponent />', function () {
  it('it should call the ready function', function () {
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_component["default"], {
      value: "site-Key",
      theme: "light",
      size: "normal",
      tabIndex: 0,
  ...
  it('it should call the render function with the right params', function () {
    ...
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_component["default"], {
      siteKey: "site-key",
      theme: "light",
      size: "normal",
      tabIndex: 0,
