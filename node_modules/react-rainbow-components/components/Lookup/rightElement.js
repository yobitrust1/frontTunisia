...
function RightElement(_ref) {
  ...
  if (showCloseButton) {
    return /*#__PURE__*/_react["default"].createElement(_closeButton["default"], null, /*#__PURE__*/_react["default"].createElement(_ButtonIcon["default"], {
      assistiveText: "close",
      size: "small",
      title: "close",
      tabIndex: -1,
  ...
  return /*#__PURE__*/_react["default"].createElement(_inputIcon["default"], {
    error: error
  }, icon);
}
