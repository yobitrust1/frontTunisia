...
describe('<Tabset />', function () {
  it('should render the children passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_index["default"], null, /*#__PURE__*/_react["default"].createElement("p", null, "testing tabset")));
  ...
  it('should not call updateButtonsVisibility function if any child is changed', function () {
    ...
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_index["default"], null, /*#__PURE__*/_react["default"].createElement(_Tab["default"], {
      label: "Tab-1",
      name: "tab-1",
      registerTab: registerTabMockFn
    }), /*#__PURE__*/_react["default"].createElement(_Tab["default"], {
  ...
  it('should call updateButtonsVisibility function and set isFirstTime to false when all children are registered and is first time', function () {
    ...
    component.setState({
      tabsetChildren: [/*#__PURE__*/_react["default"].createElement(_Tab["default"], {
        label: "Tab-1",
        name: "tab-1",
        registerTab: registerTabMockFn
      }), /*#__PURE__*/_react["default"].createElement(_Tab["default"], {
