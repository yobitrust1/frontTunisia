...
describe('<Icon/>', function () {
  it('should return the icon passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_icon["default"], {
  ...
  it('should render the fallback icon when no icon is passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_icon["default"], null));
