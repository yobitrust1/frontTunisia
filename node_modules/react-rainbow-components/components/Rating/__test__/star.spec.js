...
describe('<Star />', function () {
  it('should set type radio to the input element', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_star["default"], null));
  ...
  it('should set the name passed to the name prop of the input element', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_star["default"], {
      name: "name-1"
    }));
