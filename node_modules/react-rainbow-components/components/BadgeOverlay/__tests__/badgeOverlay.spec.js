...
describe('<BadgeOverlay/>', function () {
  it('should render the children when is passed', function () {
    ...
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], null, children));
    expect(component.contains(children)).toBe(true);
  });
  it('should not render when the children is not passed', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], defaultProps));
  ...
  it('should render with right default props', function () {
    ...
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_["default"], defaultProps, children));
