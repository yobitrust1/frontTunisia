...
describe('<Event />', function () {
  it('should render the right event data', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_event["default"], event));
  ...
  it('should call onEventClick with the right event when click the button', function () {
    ...
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_event["default"], (0, _extends2["default"])({}, event, {
