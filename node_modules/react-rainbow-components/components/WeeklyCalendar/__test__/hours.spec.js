...
describe('<Hours />', function () {
  it('should hidden 3 AM when clock is 3:10 AM', function () {
    var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_hours["default"], null));
  ...
  it('should call setToday when today is differrent to day of clock', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_hours["default"], {
                today: today,
