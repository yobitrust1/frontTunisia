...
describe('<ButtonOption />', function () {
  it('should set disabled prop of input to true when disabled prop is true', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_index.Component, null, /*#__PURE__*/_react["default"].createElement(_index2["default"], {
      label: "Option 1",
      disabled: true
    })));
  ...
  it('should set the name passed through context to the name prop of the input element', function () {
    var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_context.ButtonGroupPickerContext.Provider, {
      value: {
        name: 'group-name'
      }
