...
var PageAccordionSection = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(PageAccordionSection, [{
    ...
    value: function clickButtonIcon() {
      $(this.rootElement).$('[data-id="accordion-section-summary"] > button').click();
    }
    /**
    ...
    value: function hasFocusButtonIcon() {
      return $(this.rootElement).$('[data-id="accordion-section-summary"] > button').isFocused();
    }
    /**
    ...
    value: function getLabel() {
      return $(this.rootElement).$('[title="Accordion Label"]').getText();
    }
  }]);
