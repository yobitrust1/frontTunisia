...
describe('attachThemeAttrs', function () {
  ...
  var StyledComponent = (0, _attachThemeAttrs["default"])(_styledComponents["default"].div)(_templateObject(), function (props) {
  ...
  it('should return a merge object with props and default themes values when props.theme.rainbow is an empty', function () {
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(StyledComponent, {
      test: true
    }));
